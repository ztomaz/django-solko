...
from obligations.views import save_or_edit_obligation, get_obligations, get_quick_obligations
...
urlpatterns = patterns('',
    ...
    url(r'^get_obligations', get_obligations, name='get_obligations'),
    url(r'^get_quick_obligations', get_quick_obligations, name='get_quick_obligations'),
)
